              ...
              child: SingleChildScrollView(
                child: Column(
                  children: <Widget>[
                    ...
                    productListing('Fundamentals', 'Learning Fundamentals well..', 'inactive'),
                    productListing('Practicals in studies', 'improve practical skill.', 'inactive'),
                    productListing('Exam Papers', 'improve knowledge', 'inactive')
                  ],
                ),
              ),
            )
